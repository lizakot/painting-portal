...
<nav class="navbar">
    ...
    <button><a href="login.php" class="sort">Войти как админ</a></button>
    ...
    <section id = "about" class = "about py-7">
        ...
        <section id = "about" class = "about py-7">
            <div class = "container">
                <div class = "about-content grid">
                    <div class = "about-left">
                        <img src = "./images/tre_glav.jpeg" alt = "">
                    </div>
                    <div class = "about-right">
                        <div class = "title">
                            <h2>Государственная третьяковская галерея</h2>
                        </div>
                        <?php
                        if ($result = $connect->query("SELECT kursovaya.`сultural institution`.title, kursovaya.`сultural institution`.country, kursovaya.`сultural institution`.city,
                        kursovaya.`сultural institution`.street, kursovaya.`сultural institution`.house_number from kursovaya.`сultural institution` where kursovaya.`сultural institution`.id_c = 6"))
                        $var = $result->fetch_object();
                        $result->close();
                        ?>
                        <p class = "lead">Страна:<?php echo $var->country?></p>
        ...
        <section id = "about" class = "about py-7">
            <div class = "container">
                <div class = "about-content grid">
                    <div class = "about-left">
                        <img src = "./images/nac_glav.jpg" alt = "">
                    </div>
                    <div class = "about-right">
                        <div class = "title">
                            <h2>Национальный музей Прадо</h2>
                        </div>
                        <?php
                        if ($result = $connect->query("SELECT kursovaya.`сultural institution`.title, kursovaya.`сultural institution`.country, kursovaya.`сultural institution`.city,
                        kursovaya.`сultural institution`.street, kursovaya.`сultural institution`.house_number from kursovaya.`сultural institution` where kursovaya.`сultural institution`.id_c = 9"))
                        $var = $result->fetch_object();
                        $result->close();
                        ?>
                        <p class = "lead">Страна:<?php echo $var->country?></p>
        ...
        <section id = "about" class = "about py-7">
            <div class = "container">
                <div class = "about-content grid">
                    <div class = "about-left">
                        <img src = "./images/gett_glav.jpg" alt = "">
                    </div>
                    <div class = "about-right">
                        <div class = "title">
                            <h2>Музей Гетти</h2>
                        ...
                        <?php
                        if ($result = $connect->query("SELECT kursovaya.`сultural institution`.title, kursovaya.`сultural institution`.country, kursovaya.`сultural institution`.city,
                        kursovaya.`сultural institution`.street, kursovaya.`сultural institution`.house_number from kursovaya.`сultural institution` where kursovaya.`сultural institution`.id_c = 10"))
                        $var = $result->fetch_object();
                        $result->close();
                        ?>
                        <p class = "lead">Страна:<?php echo $var->country?></p>
