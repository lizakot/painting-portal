...
<body>
    ...
    <button><a href="sort.php" class="sort">Сортировка</a></button>
    <button><a href="poisk.php" class="sort1">Поиск</a></button>
    <button><a href="index.php" class="sort">На главную страницу</a></button>
    <!-- <a href="ar.php" class="sort">Сортировка</a> -->
            ...
            <div class="container">
                <div class="about-content grid">
                    ...
                    <div class="about-right">
                        ...
                        <p class="lead">Страна:<?php echo $var->country?></p>
                        <p class="lead">Количество написанных картин:<?php echo $var->amount_of_paintings?></p>
                        <p class="lead"><a href = "st1.php">Стиль:<?php echo $var->style_title?></p>
                        <p class="lead"><a href = "les.php">Техника:<?php echo $var1->technique_title?></p>
                        <a href="#work" class="btn-down">
                            <i class="fas fa-chevron-down"></i>
                        </a>
                    </div>
            ...
            <div class="container">
                <div class="about-content grid">
                    ...
                    <div class="about-right">
                        ...
                        <p class="lead">Количество написанных картин:<?php echo $var->amount_of_paintings?></p>
                        <p class="lead">Стиль:<?php echo $var->style_title?></p>
                        <p class="lead"><a href = "t1.php">Техника:<?php echo $var1->technique_title?></p>
                        <a href="#work" class="btn-down">
                            <i class="fas fa-chevron-down"></i>
                        </a>
                    </div>
